...
<head>
  ...
  <style>
    ...
    .slider { -webkit-appearance: none; margin: 14px; width: 400px; height: 15px; border-radius: 5px; background: #F9a6de; outline: none; -webkit-transition: .2s; transition: opacity .2s;}
    .slider::-webkit-slider-thumb {-webkit-appearance: none; appearance: none; width: 25px; height: 25px; border-radius: 12px; background: #0F0F0F; cursor: pointer;}
    .slider::-moz-range-thumb { width: 25px; height: 25px; border-radius: 12px; background: #74D4D; cursor: pointer; } 
  </style>
</head>
...
<body>
  ...
  <p>
  	<!input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_UV" min="0" max="100" value="%SLIDERVALUE%" step="1" class="slider1"> <span id="textSliderValue_UV">%SLIDERVALUE%</span> &#37
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> UV
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> VI
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> RB
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> IB
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> GR
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> RD
  </p>
  <p>
  	<input type="range" onchange="updateSliderPWM(this)" id="pwmSlider_DeepBlue" min="0" max="100" value=20 step="1"> CW
  </p>
